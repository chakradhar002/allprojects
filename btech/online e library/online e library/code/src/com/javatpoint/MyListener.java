	...
	public void contextInitialized(ServletContextEvent arg0) {
      ...
      try{
       ...
       if(status==0)
		...
		PreparedStatement ps3=con.prepareStatement("CREATE SEQUENCE Billing MINVALUE 1 MAXVALUE 999999999999 INCREMENT BY 1 START WITH 1 NOCACHE  NOORDER  NOCYCLE");
		ps3.executeUpdate();
