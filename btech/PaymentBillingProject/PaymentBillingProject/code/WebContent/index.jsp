...
<body>
	<div id="outer">
				...
				<tr>
					<td><div>
							<marquee direction="up" width="300px" truespeed="truespeed"
								...
								Date of fee Submission is 15/10/2024 After that You'll have to pay
								Rs 500  per day as a fine and your tution fee exclusively </marquee>
						</div></td>
				</tr>
			</table>
			<center>
		...
		<div id="header">
			<h4>
				Copyright 2024 All rights reserved.fore more information please
				visit: <a href="www.billing.com"><font style="color: yellow;">Billing.com</font></a>
			</h4>
		</div>
