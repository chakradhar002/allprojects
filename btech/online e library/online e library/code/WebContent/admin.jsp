...
<div id="templatemo_content_wrapper">
	...
	<div id="templatemo_sidebar">
    	...
    	<div class="sidebar_box">
            ...
            <div class="news_box">
                ...
                <p class="post_info">Posted by <a href="#">Admin</a> on <span>April 30, 2024</span></p>
            </div>
            
            <div class="news_box">
                <a href="#">Integer imperdiet, justo ut venenatis vehicula, magna mi placerat felis.</a>
                <p class="post_info">Posted by <a href="#">Admin</a> on <span>April 22, 2024</span></p>
            </div>
            
            <div class="news_box">
                <a href="#">Sed justo dolor, convallis at, vestibulum vitae, elementum eu, pede.</a>
                <p class="post_info">Posted by <a href="#">Admin</a> on <span>April 14, 2024</span></p>
            </div>
        ...
        <div class="sidebar_box">
           ...
           <h2>JAVA</h2>
            ...
            <div class="section_w250 float_l">
				<h3>Core Java</h3>            
				<p>oops is a concept of core java so. Billing.com ,is realy a very good website we must visit,on this web site,to know java in defth and cstpoint.com.</p>
           </div>
	...
	%>
    	...
    	<form name=F1 onSubmit="return dil(this)" action="admin1.jsp" >
            ...
            <div class="section_w250 float_l">
				<h3>Core Java</h3>            
				<p>oops is a concept of core java so. Billing.com ,is realy a very good website we must visit,on this web site,to know java in defth.</p>
           </div>
        ...
        <%--
            ...
            <p> <a href="http://www.templatemo.com/page/1" target="_parent">Free Projects</a> are provided by <a href="http://www.Billing.com" target="_parent">Billing.com</a> for everyone. Feel free to download, edit and apply this project for your personal or business websites. Validate <a href="http://www.Billing.com">corejava</a> &amp; <a href="http://www.Billing.com">servlet</a>. Credit goes to <a href="http://www.Billing.com/">Public Domain Pictures</a> for photos used in this template. Nam ut libero at lacus feugiat tincidunt vitae sed ipsum.</p>
...
<div id="templatemo_footer_wrapper">
    ...
    <div id="templatemo_footer">
        ...
        <ul class="footer_menu">
                ...
                <a href="http://www.Billing.com" target="_parent">Website Projects</a> by <a href="http://www.Billing.com" target="_parent">Billing.com</a></div>
    
</div>
<div align=center>This project  downloaded form <a href='http://www.Billing.com/'>free website projects</a></div></body>
</html>